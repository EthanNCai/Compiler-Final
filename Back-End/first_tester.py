from parser.Grammar import token_to_terminator_bb, GRAMMAR_WITH_EPSILON, PL0_NON_TERMINATOR_NEW, PL0_GRAMMAR, \
    PL0_TERMINATOR_NEW
from parser.ExpressionFirstFinding import find_first

ret = find_first([':=', 'EXPR', '.'], PL0_NON_TERMINATOR_NEW, PL0_GRAMMAR,
                 PL0_TERMINATOR_NEW)
